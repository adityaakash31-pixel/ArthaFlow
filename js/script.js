...
// ---------- Clear GST Only ----------
function clearGSTStorage(){

    deleteData("companyDetails");
    deleteData("customerDetails");
    deleteData("paymentDetails");
    deleteData("invoiceHistory");
    deleteData("draftInvoice");
    deleteData("invoiceProducts");
    deleteData("companyLogo");
